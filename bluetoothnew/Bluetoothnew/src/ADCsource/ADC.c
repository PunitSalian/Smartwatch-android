...
/*******************************************************************************
* File Name     : S12ADC.C
* Description   :  driver for the S12ADC (12-bit A/D converter)
*                  
*******************************************************************************/
...
void S12ADC_init (void)
{
    ...
    */
    S12AD.ADANS0.WORD = 0x0008; /* Read AN003, which is connected to the potentiometer */
...
* Description  : Reads the results register for channel AN003 of the S12ADC
* Arguments    : none
